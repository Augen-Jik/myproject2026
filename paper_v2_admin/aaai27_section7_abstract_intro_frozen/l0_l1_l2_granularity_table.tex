...
\begin{tabular}{@{}p{2.15cm}ccccc@{}}
\toprule
Interface & \shortstack{Road\\rec.$^\dagger$} & Dir. & \shortstack{Conflict\\res.} & Schema & \shortstack{Closed-loop\\CS} \\
\midrule
L1 dense edge-weight   & --    & --   & --   & --   & \shortstack{0.02\\(uniform enum.)} \\
