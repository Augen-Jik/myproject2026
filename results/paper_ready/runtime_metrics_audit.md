...
- Final metrics copy: `/root/autodl-tmp/results/final_tables/metrics.csv`
- Final aggregate table: `/root/autodl-tmp/results/final_tables/method_comparison_final.csv`
...
- Path: `/root/autodl-tmp/results/paper_ready/truncated_runs_audit.csv`
- Rows: 7
